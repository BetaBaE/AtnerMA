...
import ProjectNavArrowsWrapper from '@/components/realisations/ProjectNavArrowsWrapper';
...
export default async function ProjectDetailPage({ params }) {
  ...
  const prevProject = sorted[(currentIdx - 1 + sorted.length) % sorted.length];
  const nextProject = sorted[(currentIdx + 1) % sorted.length];
  ...
  return (
    <>
      ...
      <ProjectNavArrowsWrapper prevProject={prevProject} nextProject={nextProject} />
